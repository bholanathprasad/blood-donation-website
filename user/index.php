...
<?php 
	...
	if(isset($_SESSION['user_id']) && !empty($_SESSION['user_id'])) {
		...
		$showForm='	<div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>Are you sure update this record?</strong>
					...
					<div class="panel panel-default" style="padding: 20px;">
						...
						<?php if(isset($submitError)) echo $submitError;?>
							...
							if($safeDate=='0'){
								...
								}else{ echo '<div class="donors_data">
									<span class="name">congratulation</span>
									<span>you have already sav the life.You will donate the blood after 3 months</span>
